...
public class TestMaze
{
	...
	public static void main(String[] args)
	{
		...
		if (testObject instanceof Edge)
		{
			...
			{
				System.out.println(
						"The MazeObject " + testObject.toString() + " at (topo) " + testCoordinate.toString() + " is a Boundary Wall");
				System.out.println();
			}
		}
		...
		System.out.println(testObject.toString() + " at (topo) " + testCoordinate.toString() + " is " + testObject.getHeight() + " cm or "
				+ testObject.getHeight() / CM_PER_PIXEL + " Pixels high and " + testObject.getWidth() + " cm or "
				+ testObject.getWidth() / CM_PER_PIXEL + " Pixels Wide");
		System.out.println();
		...
		for (MazeObject neighbour : testObject.getNeighbours())
		{
			if (neighbour != null)
				System.out.println(neighbour.toString() + " at position (topo) " + neighbour.getTopologicalPosition().toString()
						+ " traversable: " + neighbour.isTraversable());
		}
		...
		if (testObject instanceof Tile)
		{
			...
			for (Bearing direction : MazeSolvingRobot.getCARDINALS())
			{
				...
				{
					System.out.println(neighbouringTile.toString() + " at position (topo) "
							+ neighbouringTile.getTopologicalPosition().toString() + ":");
