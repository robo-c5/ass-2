...
public class TestMazeObjectEquals
{
	...
	public static void main(String args[]) throws Exception
	{
		...
		System.out.println("Is MazeObject " + origin.toString() + " at (topo) " + origin.getTopologicalPosition().toString() + " equal to "
				+ destination.toString() + " at (topo) " + destination.getTopologicalPosition().toString() + ": " + areEqual1);
		System.out.println("Is MazeObject " + destination.toString() + " at (topo) " + destination.getTopologicalPosition().toString()
				+ " equal to " + origin.toString() + " at (topo) " + origin.getTopologicalPosition().toString() + ": " + areEqual2);
